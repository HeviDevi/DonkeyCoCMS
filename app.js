...
const getEmployees = async () => {
    ...
    console.log('Here are all of our current employees, their roles, and their managers:')
...
const addEmployee = async () => {
    try {
        ...
        console.log(`Added ${chosenFirstName} ${chosenLastName} to the database, Welcome Aboard!`)
} catch (err) {
    console.error(err)
}
}
